...
# Chille, China, Germany, Mexico, USA, Zimbabwe
...
f, ax = plt.subplots(figsize=(15,10))
ax.set_title('Average Life Expectancy at birth year per country (LEABY)')
sns.barplot(data=df,x='Country',y='LEABY')
plt.savefig("avg_lifeExpec.png")
plt.show()
...
# # Answer
# Average life expectancy does not appear to correlate to the average GDP
...
ax.set(title='Life expectancy distribution per country')
#ax.set(style="whitegrid")
sns.violinplot(data=df,x='Country',y='LEABY',palette='husl')
plt.ylabel('Life expectancy at birth (years)')
plt.savefig("lifeExpec_dist.png")
plt.show()
...
#  # Answer
#  Zimbabwe appears to have the largest distribution in the life expectancy at birth year
...
ax.set(title='Life Expectancy over time')
...
# - The last 10 years have seen the biggest changes for both countries
...
#   - Chile, China, Germany, Mexico, and the US have very similar life expactancy and growth over the 15-year timeframe
# - GDP and Life Expectancy still do not seem to be strongly correlated
...
plt.savefig("gdp_func_lifeExpec.png")
plt.show()
...
# # Answers
# 
# - China moves the most along the x-axis (GDP)
# - Zimbabwe moves the most along the y-axis (Life Expectancy)
# - Based on the previous charts this is not surprising, but the scatter plot makes the comparison between countries easier
...
plt.savefig("leaby_year_country.png")
plt.show()
...
# # Answers
# 
# - Zimbabwe has seen the most change over this time period
# - 2005-2015 have seen the largest change for Zimbabwe
# - The US has seen the least change in life expectancy
# - In 2005 Zimbabwe must have made changes in health care and disease prevention
...
plt.savefig("gdp_year_country.png")
plt.show()
...
# # Answer
# The US and China have the highest GDP, and Chile and Zimbabwe have the lowest

# Which countries have the highest and lowest life expectancy?

# # Answer
# Chile and Germany have the highest life expectancy, and Zimbabwe has the lowest
...
# # Answer
# Zimbabwe has been ravaged by HIV/AIDS, but in the last 10 years, progress has been made to help prevent spread of the disease and treat those afflicted
...
# # Answers
# 
# - Chile has enjoyed a long life expectancy, but doesn't have a strong GDP in relation to the other countries in the dataset
